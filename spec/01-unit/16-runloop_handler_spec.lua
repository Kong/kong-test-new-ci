...
describe("runloop handler", function()
  describe("router rebuilds", function()
    ...
    it("does not call update_router if proxy_state_consistency is eventual", function()
      setup_it_block()
    ...
    it("calls build_router if router version changes and proxy_state_consistency is strict", function()
      setup_it_block()

      kong.configuration.proxy_state_consistency = "strict"
    ...
    it("does not call build_router if router version does not change and proxy_state_consistency is strict", function()
      setup_it_block()
